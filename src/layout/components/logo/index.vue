...
<template>
    ...
    <h1 class="font-['Pacifico'] text-white text-3xl mb-2">logo</h1>
    <p class="text-gray-300 text-sm font-medium">欢迎回来，请登录您的账号</p>
    </div>
    <div class="flex w-full mb-6">
    <button
    class="flex-1 py-2 text-center text-gray-300 border-b-2 transition-all"
    :class="{'border-primary text-white': loginType === 'email'}"
    ...
    <button
    class="flex-1 py-2 text-center text-gray-300 border-b-2 transition-all"
    :class="{'border-primary text-white': loginType === 'phone'}"
